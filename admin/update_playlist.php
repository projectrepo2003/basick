...
if(isset($_POST['submit'])){
   ...
   $update_playlist = $conn->prepare("UPDATE `playlist` SET category = ?, title = ?, description = ?, status = ? WHERE id = ?");
   $update_playlist->execute([$category, $title, $description, $status, $get_id]);
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         <option value="<?= $fetch_playlist['category']; ?>" selected><?= $fetch_playlist['category']; ?></option>
